...
public class Center extends SequentialCommandGroup {
   ...
   */
  public Center(Trajectory trajectory, ShooterSubsystem shooter, IntakeSubsystem intake, DriveSubsystem drive,HopperSubsystem hopper) {
    ...
    trajectory.getRamsete(trajectory.center_0).raceWith(new RunHopper(hopper, 0.5))
